...
# pour Heroku, trail sur moins de données (sinon joblib.dump trop volumineux)
df_heroku=df_80[:10000]
...
X = df_heroku[list_features_only]  # V1 et V3
...
joblib.dump(pipe, result_path_base + 'pipeline_credit_Heroku_compress9.joblib', compress=9)
